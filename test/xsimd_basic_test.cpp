...
{
    std::ofstream out("log/avx_float_basic.log", std::ios_base::out);
    bool res = xsimd::test_simd<float, 16, 64>(out, "avx float");
    EXPECT_TRUE(res);
}
...
{
    std::ofstream out("log/avx_double_basic.log", std::ios_base::out);
    bool res = xsimd::test_simd<double, 8, 64>(out, "avx double");
    EXPECT_TRUE(res);
}
...
{
    std::ofstream out("log/avx_int32_basic.log", std::ios_base::out);
    bool res = xsimd::test_simd_int<int32_t, 16, 64>(out, "avx int32");
    EXPECT_TRUE(res);
}
...
{
    std::ofstream out("log/avx_int64_basic.log", std::ios_base::out);
    bool res = xsimd::test_simd_int<int64_t, 8, 64>(out, "avx int64");
    EXPECT_TRUE(res);
}
...
{
    std::ofstream out("log/avx_conversion.log", std::ios_base::out);
    bool res = xsimd::test_simd_convert<8, 64>(out, "avx conversion");
    EXPECT_TRUE(res);
}
...
{
    std::ofstream out("log/avx_cast.log", std::ios_base::out);
    bool res = xsimd::test_simd_cast<8, 64>(out, "avx cast");
    EXPECT_TRUE(res);
}
TEST(xsimd, avx_load)
{
    std::ofstream out("log/avx_load.log", std::ios_base::out);
    bool res = xsimd::test_simd_load<8, 64>(out, "avx load");
    EXPECT_TRUE(res);
}
...
{
    std::ofstream out("log/avx_store.log", std::ios_base::out);
    bool res = xsimd::test_simd_store<8, 64>(out, "avx store");
    EXPECT_TRUE(res);
}
#endif
